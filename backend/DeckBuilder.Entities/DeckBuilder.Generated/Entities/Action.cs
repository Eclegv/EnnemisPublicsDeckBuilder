...
{
    public interface IActionOriginalData : ICardOriginalData
    {
    }

    public partial class Action : OGM<Action, Action.ActionData, System.String>, ICard, IActionOriginalData
    {
        #region Initialize
        ...
        public static Dictionary<System.String, Action> LoadByKeys(IEnumerable<System.String> ids)
        {
        ...
        protected static void RegisterQuery(string name, Func<IMatchQuery, q.ActionAlias, IWhereQuery> query)
        {
            q.ActionAlias alias;

            IMatchQuery matchQuery = Blueprint41.Transaction.CompiledQuery.Match(q.Node.Action.Alias(out alias, "node"));
        ...
        protected override void LazySet()
        {
            ...
            if (PersistenceState == PersistenceState.NewAndChanged || PersistenceState == PersistenceState.LoadedAndChanged)
            {
                if (ReferenceEquals(InnerData, OriginalData))
                    OriginalData = new ActionData(InnerData);
            }
        }
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Name is null)
                throw new PersistenceException(string.Format("Cannot save Action with key '{0}' because the Name cannot be null.", this.Id?.ToString() ?? "<null>"));
        }
        ...
        public class ActionData : Data<System.String>
        {
            public ActionData()
            {
            ...
            #region Members for interface IAction
        ...
        private static ActionMembers members = null;
        public static ActionMembers Members
        {
            get
            {
                if (members is null)
        ...
        private static ActionFullTextMembers fullTextMembers = null;
        public static ActionFullTextMembers FullTextMembers
        {
            get
            {
                if (fullTextMembers is null)
                {
                    ...
                    {
                        if (fullTextMembers is null)
                            fullTextMembers = new ActionFullTextMembers();
                    }
                }
        ...
        public class ActionFullTextMembers
        {
            internal ActionFullTextMembers() { }
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = DeckBuilder.Model.Datastore.Model.Entities["Action"];
                }
            }
            return entity;
        }

        private static ActionEvents events = null;
        public static ActionEvents Events
        {
            get
            {
                if (events is null)
        ...
        public class ActionEvents
        {
            ...
            private EventHandler<Action, EntityEventArgs> onNew;
            public event EventHandler<Action, EntityEventArgs> OnNew
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Action, EntityEventArgs> handler = onNew;
                if (handler is not null)
                    handler.Invoke((Action)sender, args);
            }
            ...
            private EventHandler<Action, EntityEventArgs> onDelete;
            public event EventHandler<Action, EntityEventArgs> OnDelete
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Action, EntityEventArgs> handler = onDelete;
                if (handler is not null)
                    handler.Invoke((Action)sender, args);
            }
            ...
            private EventHandler<Action, EntityEventArgs> onSave;
            public event EventHandler<Action, EntityEventArgs> OnSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Action, EntityEventArgs> handler = onSave;
                if (handler is not null)
                    handler.Invoke((Action)sender, args);
            }
            ...
            private EventHandler<Action, EntityEventArgs> onAfterSave;
            public event EventHandler<Action, EntityEventArgs> OnAfterSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Action, EntityEventArgs> handler = onAfterSave;
                if (handler is not null)
                    handler.Invoke((Action)sender, args);
            }
            ...
            public static class OnPropertyChange
            {
                ...
                private static EventHandler<Action, PropertyEventArgs> onName;
                public static event EventHandler<Action, PropertyEventArgs> OnName
                {
                    add
                    {
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onName;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onBaseEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnBaseEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onBaseEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onReactionEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnReactionEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onReactionEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onEnteringEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnEnteringEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onEnteringEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onLeavingEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnLeavingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onLeavingEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onActivationEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onMandatoryActivationEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnMandatoryActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onMandatoryActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onPermanentEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnPermanentEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onPermanentEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onLoosingEffect;
                public static event EventHandler<Action, PropertyEventArgs> OnLoosingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onLoosingEffect;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onLore;
                public static event EventHandler<Action, PropertyEventArgs> OnLore
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onLore;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onId;
                public static event EventHandler<Action, PropertyEventArgs> OnId
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onId;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
                ...
                private static EventHandler<Action, PropertyEventArgs> onCardSet;
                public static event EventHandler<Action, PropertyEventArgs> OnCardSet
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Action, PropertyEventArgs> handler = onCardSet;
                    if (handler is not null)
                        handler.Invoke((Action)sender, args);
                }
        ...
        #region IActionOriginalData

        public IActionOriginalData OriginalVersion { get { return this; } }
