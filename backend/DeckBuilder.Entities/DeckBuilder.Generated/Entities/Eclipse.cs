...
namespace DeckBuilder.Generated.Manipulation
{
    ...
    public partial class Eclipse : OGM<Eclipse, Eclipse.EclipseData, System.String>, IValue, ICard, IEclipseOriginalData
    {
        ...
        public static Dictionary<System.String, Eclipse> LoadByKeys(IEnumerable<System.String> ids)
        {
        ...
        protected static void RegisterQuery(string name, Func<IMatchQuery, q.EclipseAlias, IWhereQuery> query)
        {
            q.EclipseAlias alias;

            IMatchQuery matchQuery = Blueprint41.Transaction.CompiledQuery.Match(q.Node.Eclipse.Alias(out alias, "node"));
        ...
        protected override void LazySet()
        {
            ...
            if (PersistenceState == PersistenceState.NewAndChanged || PersistenceState == PersistenceState.LoadedAndChanged)
            {
                if (ReferenceEquals(InnerData, OriginalData))
                    OriginalData = new EclipseData(InnerData);
            }
        }
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Name is null)
                throw new PersistenceException(string.Format("Cannot save Eclipse with key '{0}' because the Name cannot be null.", this.Id?.ToString() ?? "<null>"));
        }
        ...
        public class EclipseData : Data<System.String>
        {
            public EclipseData()
            {
            ...
            public EclipseData(EclipseData data)
            {
            ...
            sealed public override IDictionary<string, object> MapTo()
            {
                ...
                dictionary.Add("EclipseEffect",  EclipseEffect);
            ...
            {
                object value;
                if (properties.TryGetValue("EclipseEffect", out value))
                    EclipseEffect = (string)value;
            ...
            #region Members for interface IEclipse
        ...
        #region Ally (Collection)

        public List<ECLIPSING> AllyRelations()
        {
            return ECLIPSING.Load(_queryAllyRelations.Value, ("key", Id));
        }
        private readonly Lazy<ICompiled> _queryAllyRelations = new Lazy<ICompiled>(delegate()
        {
        ...
        public List<ECLIPSING> AllyWhere(Func<ECLIPSING.Alias, QueryCondition> expression)
        {
            var query = Transaction.CompiledQuery
                .Match(node.Eclipse.Alias(out var inAlias).In.ECLIPSING.Alias(out var relAlias).Out.Allie.Alias(out var outAlias))
                .Where(inAlias.Id == Id)
                .And(expression.Invoke(new ECLIPSING.Alias(relAlias, inAlias, outAlias)))
                .Return(relAlias.ElementId.As("elementId"), relAlias.Properties("properties"), inAlias.As("in"), outAlias.As("out"))
                .Compile();

            return ECLIPSING.Load(query);
        }
        public List<ECLIPSING> AllyWhere(Func<ECLIPSING.Alias, QueryCondition[]> expression)
        {
            var query = Transaction.CompiledQuery
        ...
        public List<ECLIPSING> AllyWhere(JsNotation<System.DateTime?> CreationDate = default)
        {
            return AllyWhere(delegate(ECLIPSING.Alias alias)
            {
        ...
        public void AddAlly(Allie allie)
        {
            Dictionary<string, object> properties = new Dictionary<string, object>();
            ((ILookupHelper<Allie>)InnerData.Ally).AddItem(allie, null, properties);
        }
        public void RemoveAlly(Allie allie)
        {
            Ally.Remove(allie);
        }
        ...
        private static EclipseMembers members = null;
        public static EclipseMembers Members
        {
            get
            {
                if (members is null)
                {
                    ...
                    {
                        if (members is null)
                            members = new EclipseMembers();
                    }
                }
                return members;
            }
        }
        public class EclipseMembers
        {
            internal EclipseMembers() { }
        ...
        private static EclipseFullTextMembers fullTextMembers = null;
        public static EclipseFullTextMembers FullTextMembers
        {
            get
            {
                if (fullTextMembers is null)
                {
                    ...
                    {
                        if (fullTextMembers is null)
                            fullTextMembers = new EclipseFullTextMembers();
                    }
                }
        ...
        public class EclipseFullTextMembers
        {
            internal EclipseFullTextMembers() { }
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = DeckBuilder.Model.Datastore.Model.Entities["Eclipse"];
                }
            }
            return entity;
        }

        private static EclipseEvents events = null;
        public static EclipseEvents Events
        {
            get
            {
                if (events is null)
        ...
        public class EclipseEvents
        {
            ...
            private EventHandler<Eclipse, EntityEventArgs> onNew;
            public event EventHandler<Eclipse, EntityEventArgs> OnNew
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Eclipse, EntityEventArgs> handler = onNew;
            ...
            private EventHandler<Eclipse, EntityEventArgs> onDelete;
            public event EventHandler<Eclipse, EntityEventArgs> OnDelete
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Eclipse, EntityEventArgs> handler = onDelete;
                if (handler is not null)
                    handler.Invoke((Eclipse)sender, args);
            }
            ...
            private EventHandler<Eclipse, EntityEventArgs> onSave;
            public event EventHandler<Eclipse, EntityEventArgs> OnSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Eclipse, EntityEventArgs> handler = onSave;
                if (handler is not null)
                    handler.Invoke((Eclipse)sender, args);
            }
            ...
            private EventHandler<Eclipse, EntityEventArgs> onAfterSave;
            public event EventHandler<Eclipse, EntityEventArgs> OnAfterSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Eclipse, EntityEventArgs> handler = onAfterSave;
                if (handler is not null)
                    handler.Invoke((Eclipse)sender, args);
            }
            ...
            public static class OnPropertyChange
            {
                ...
                #region OnEclipseEffect

                private static bool onEclipseEffectIsRegistered = false;

                private static EventHandler<Eclipse, PropertyEventArgs> onEclipseEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnEclipseEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                        {
                            if (!onEclipseEffectIsRegistered)
                            {
                                Members.EclipseEffect.Events.OnChange -= onEclipseEffectProxy;
                                Members.EclipseEffect.Events.OnChange += onEclipseEffectProxy;
                                onEclipseEffectIsRegistered = true;
                            }
                            onEclipseEffect += value;
                        }
                    }
                    remove
                    {
                        ...
                        {
                            onEclipseEffect -= value;
                            if (onEclipseEffect is null && onEclipseEffectIsRegistered)
                            {
                                Members.EclipseEffect.Events.OnChange -= onEclipseEffectProxy;
                                onEclipseEffectIsRegistered = false;
                            }
                        }
                    }
                }
            
                private static void onEclipseEffectProxy(object sender, PropertyEventArgs args)
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onEclipseEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static bool onAllyIsRegistered = false;

                private static EventHandler<Eclipse, PropertyEventArgs> onAlly;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnAlly
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                        {
                            if (!onAllyIsRegistered)
                            {
                                Members.Ally.Events.OnChange -= onAllyProxy;
                                Members.Ally.Events.OnChange += onAllyProxy;
                                onAllyIsRegistered = true;
                            }
                            onAlly += value;
                        }
                    }
                    remove
                    {
                        ...
                        {
                            onAlly -= value;
                            if (onAlly is null && onAllyIsRegistered)
                            {
                                Members.Ally.Events.OnChange -= onAllyProxy;
                                onAllyIsRegistered = false;
                            }
                        }
                    }
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onName;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnName
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onName;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onBaseEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnBaseEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onBaseEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onReactionEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnReactionEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onReactionEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onEnteringEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnEnteringEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onEnteringEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onLeavingEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnLeavingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onLeavingEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onActivationEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onMandatoryActivationEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnMandatoryActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onMandatoryActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onPermanentEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnPermanentEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onPermanentEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onLoosingEffect;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnLoosingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onLoosingEffect;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onLore;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnLore
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onLore;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onId;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnId
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onId;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
                ...
                private static EventHandler<Eclipse, PropertyEventArgs> onCardSet;
                public static event EventHandler<Eclipse, PropertyEventArgs> OnCardSet
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Eclipse, PropertyEventArgs> handler = onCardSet;
                    if (handler is not null)
                        handler.Invoke((Eclipse)sender, args);
                }
        ...
        public static class StaticData
        {
            ...
            /// <summary>
            /// Get the 'Key' value for the corresponding EclipseEffect
            /// </summary>
            public static class EclipseEffect
            {
                public static bool Exist(string eclipseEffect)
                {
                    return false;
                }
            }
        ...
        #region IEclipseOriginalData

        public IEclipseOriginalData OriginalVersion { get { return this; } }
