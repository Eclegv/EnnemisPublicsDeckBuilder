...
{
    public interface ISbireOriginalData : ICardOriginalData
    {
        IEnumerable<Token> Tokens { get; }
    }

    public partial class Sbire : OGM<Sbire, Sbire.SbireData, System.String>, ICard, ISbireOriginalData
    {
        #region Initialize
        ...
        public static Dictionary<System.String, Sbire> LoadByKeys(IEnumerable<System.String> ids)
        {
        ...
        protected static void RegisterQuery(string name, Func<IMatchQuery, q.SbireAlias, IWhereQuery> query)
        {
            q.SbireAlias alias;

            IMatchQuery matchQuery = Blueprint41.Transaction.CompiledQuery.Match(q.Node.Sbire.Alias(out alias, "node"));
        ...
        protected override void LazySet()
        {
            ...
            if (PersistenceState == PersistenceState.NewAndChanged || PersistenceState == PersistenceState.LoadedAndChanged)
            {
                if (ReferenceEquals(InnerData, OriginalData))
                    OriginalData = new SbireData(InnerData);
            }
        }
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Name is null)
                throw new PersistenceException(string.Format("Cannot save Sbire with key '{0}' because the Name cannot be null.", this.Id?.ToString() ?? "<null>"));
        }
        ...
        public class SbireData : Data<System.String>
        {
            public SbireData()
            {
            ...
            public SbireData(SbireData data)
            {
                Tokens = data.Tokens;
                Name = data.Name;
            ...
            #region Members for interface ISbire
        ...
        private static SbireMembers members = null;
        public static SbireMembers Members
        {
            get
            {
                if (members is null)
                {
                    ...
                    {
                        if (members is null)
                            members = new SbireMembers();
                    }
                }
                return members;
            }
        }
        public class SbireMembers
        {
            internal SbireMembers() { }

            #region Members for interface ISbire

            public EntityProperty Tokens { get; } = DeckBuilder.Model.Datastore.Model.Entities["Sbire"].Properties["Tokens"];
            #endregion
        ...
        private static SbireFullTextMembers fullTextMembers = null;
        public static SbireFullTextMembers FullTextMembers
        {
            get
            {
                if (fullTextMembers is null)
                {
                    ...
                    {
                        if (fullTextMembers is null)
                            fullTextMembers = new SbireFullTextMembers();
                    }
                }
        ...
        public class SbireFullTextMembers
        {
            internal SbireFullTextMembers() { }
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = DeckBuilder.Model.Datastore.Model.Entities["Sbire"];
                }
            }
            return entity;
        }

        private static SbireEvents events = null;
        public static SbireEvents Events
        {
            get
            {
                if (events is null)
                {
                    ...
                    {
                        if (events is null)
                            events = new SbireEvents();
                    }
                }
                return events;
            }
        }
        public class SbireEvents
        {
            ...
            private EventHandler<Sbire, EntityEventArgs> onNew;
            public event EventHandler<Sbire, EntityEventArgs> OnNew
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Sbire, EntityEventArgs> handler = onNew;
                if (handler is not null)
                    handler.Invoke((Sbire)sender, args);
            }
            ...
            private EventHandler<Sbire, EntityEventArgs> onDelete;
            public event EventHandler<Sbire, EntityEventArgs> OnDelete
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Sbire, EntityEventArgs> handler = onDelete;
                if (handler is not null)
                    handler.Invoke((Sbire)sender, args);
            }
            ...
            private EventHandler<Sbire, EntityEventArgs> onSave;
            public event EventHandler<Sbire, EntityEventArgs> OnSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Sbire, EntityEventArgs> handler = onSave;
                if (handler is not null)
                    handler.Invoke((Sbire)sender, args);
            }
            ...
            private EventHandler<Sbire, EntityEventArgs> onAfterSave;
            public event EventHandler<Sbire, EntityEventArgs> OnAfterSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Sbire, EntityEventArgs> handler = onAfterSave;
                if (handler is not null)
                    handler.Invoke((Sbire)sender, args);
            }
            ...
            public static class OnPropertyChange
            {
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onTokens;
                public static event EventHandler<Sbire, PropertyEventArgs> OnTokens
                {
                    add
                    {
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onTokens;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onName;
                public static event EventHandler<Sbire, PropertyEventArgs> OnName
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onName;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onBaseEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnBaseEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onBaseEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onReactionEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnReactionEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onReactionEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onEnteringEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnEnteringEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onEnteringEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onLeavingEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnLeavingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onLeavingEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onActivationEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onMandatoryActivationEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnMandatoryActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onMandatoryActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onPermanentEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnPermanentEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onPermanentEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onLoosingEffect;
                public static event EventHandler<Sbire, PropertyEventArgs> OnLoosingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onLoosingEffect;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onLore;
                public static event EventHandler<Sbire, PropertyEventArgs> OnLore
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onLore;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onId;
                public static event EventHandler<Sbire, PropertyEventArgs> OnId
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onId;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
                ...
                private static EventHandler<Sbire, PropertyEventArgs> onCardSet;
                public static event EventHandler<Sbire, PropertyEventArgs> OnCardSet
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Sbire, PropertyEventArgs> handler = onCardSet;
                    if (handler is not null)
                        handler.Invoke((Sbire)sender, args);
                }
        ...
        #region ISbireOriginalData

        public ISbireOriginalData OriginalVersion { get { return this; } }

        #region Members for interface ISbire

        IEnumerable<Token> ISbireOriginalData.Tokens { get { return OriginalData.Tokens.OriginalData; } }
