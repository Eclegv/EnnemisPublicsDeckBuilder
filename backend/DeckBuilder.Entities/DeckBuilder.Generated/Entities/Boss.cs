...
{
    public interface IBossOriginalData : ICardOriginalData
    {
    }

    public partial class Boss : OGM<Boss, Boss.BossData, System.String>, ICard, IBossOriginalData
    {
        #region Initialize
        ...
        public static Dictionary<System.String, Boss> LoadByKeys(IEnumerable<System.String> ids)
        {
        ...
        protected static void RegisterQuery(string name, Func<IMatchQuery, q.BossAlias, IWhereQuery> query)
        {
            q.BossAlias alias;

            IMatchQuery matchQuery = Blueprint41.Transaction.CompiledQuery.Match(q.Node.Boss.Alias(out alias, "node"));
        ...
        protected override void LazySet()
        {
            ...
            if (PersistenceState == PersistenceState.NewAndChanged || PersistenceState == PersistenceState.LoadedAndChanged)
            {
                if (ReferenceEquals(InnerData, OriginalData))
                    OriginalData = new BossData(InnerData);
            }
        }
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Name is null)
                throw new PersistenceException(string.Format("Cannot save Boss with key '{0}' because the Name cannot be null.", this.Id?.ToString() ?? "<null>"));
        }
        ...
        public class BossData : Data<System.String>
        {
            public BossData()
            {
            ...
            #region Members for interface IBoss
        ...
        private static BossMembers members = null;
        public static BossMembers Members
        {
            get
            {
                if (members is null)
        ...
        private static BossFullTextMembers fullTextMembers = null;
        public static BossFullTextMembers FullTextMembers
        {
            get
            {
                if (fullTextMembers is null)
                {
                    ...
                    {
                        if (fullTextMembers is null)
                            fullTextMembers = new BossFullTextMembers();
                    }
                }
        ...
        public class BossFullTextMembers
        {
            internal BossFullTextMembers() { }
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = DeckBuilder.Model.Datastore.Model.Entities["Boss"];
                }
            }
            return entity;
        }

        private static BossEvents events = null;
        public static BossEvents Events
        {
            get
            {
                if (events is null)
        ...
        public class BossEvents
        {
            ...
            private EventHandler<Boss, EntityEventArgs> onNew;
            public event EventHandler<Boss, EntityEventArgs> OnNew
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Boss, EntityEventArgs> handler = onNew;
                if (handler is not null)
                    handler.Invoke((Boss)sender, args);
            }
            ...
            private EventHandler<Boss, EntityEventArgs> onDelete;
            public event EventHandler<Boss, EntityEventArgs> OnDelete
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Boss, EntityEventArgs> handler = onDelete;
                if (handler is not null)
                    handler.Invoke((Boss)sender, args);
            }
            ...
            private EventHandler<Boss, EntityEventArgs> onSave;
            public event EventHandler<Boss, EntityEventArgs> OnSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Boss, EntityEventArgs> handler = onSave;
                if (handler is not null)
                    handler.Invoke((Boss)sender, args);
            }
            ...
            private EventHandler<Boss, EntityEventArgs> onAfterSave;
            public event EventHandler<Boss, EntityEventArgs> OnAfterSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Boss, EntityEventArgs> handler = onAfterSave;
                if (handler is not null)
                    handler.Invoke((Boss)sender, args);
            }
            ...
            public static class OnPropertyChange
            {
                ...
                private static EventHandler<Boss, PropertyEventArgs> onName;
                public static event EventHandler<Boss, PropertyEventArgs> OnName
                {
                    add
                    {
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onName;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onBaseEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnBaseEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onBaseEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onReactionEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnReactionEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onReactionEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onEnteringEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnEnteringEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onEnteringEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onLeavingEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnLeavingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onLeavingEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onActivationEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onMandatoryActivationEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnMandatoryActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onMandatoryActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onPermanentEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnPermanentEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onPermanentEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onLoosingEffect;
                public static event EventHandler<Boss, PropertyEventArgs> OnLoosingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onLoosingEffect;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onLore;
                public static event EventHandler<Boss, PropertyEventArgs> OnLore
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onLore;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onId;
                public static event EventHandler<Boss, PropertyEventArgs> OnId
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onId;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
                ...
                private static EventHandler<Boss, PropertyEventArgs> onCardSet;
                public static event EventHandler<Boss, PropertyEventArgs> OnCardSet
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Boss, PropertyEventArgs> handler = onCardSet;
                    if (handler is not null)
                        handler.Invoke((Boss)sender, args);
                }
        ...
        #region IBossOriginalData

        public IBossOriginalData OriginalVersion { get { return this; } }
