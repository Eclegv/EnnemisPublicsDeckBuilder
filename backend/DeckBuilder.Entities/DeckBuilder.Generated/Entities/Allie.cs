...
namespace DeckBuilder.Generated.Manipulation
{
    ...
    public partial class Allie : OGM<Allie, Allie.AllieData, System.String>, IValue, ICard, IAllieOriginalData
    {
        ...
        public static Dictionary<System.String, Allie> LoadByKeys(IEnumerable<System.String> ids)
        {
        ...
        protected static void RegisterQuery(string name, Func<IMatchQuery, q.AllieAlias, IWhereQuery> query)
        {
            q.AllieAlias alias;

            IMatchQuery matchQuery = Blueprint41.Transaction.CompiledQuery.Match(q.Node.Allie.Alias(out alias, "node"));
        ...
        protected override void LazySet()
        {
            ...
            if (PersistenceState == PersistenceState.NewAndChanged || PersistenceState == PersistenceState.LoadedAndChanged)
            {
                if (ReferenceEquals(InnerData, OriginalData))
                    OriginalData = new AllieData(InnerData);
            }
        }
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Name is null)
                throw new PersistenceException(string.Format("Cannot save Allie with key '{0}' because the Name cannot be null.", this.Id?.ToString() ?? "<null>"));
        }
        ...
        public class AllieData : Data<System.String>
        {
            public AllieData()
            {
            ...
            public AllieData(AllieData data)
            {
                Tokens = data.Tokens;
                Name = data.Name;
        ...
        private static AllieMembers members = null;
        public static AllieMembers Members
        {
            get
            {
                if (members is null)
                {
                    ...
                    {
                        if (members is null)
                            members = new AllieMembers();
                    }
                }
                return members;
            }
        }
        public class AllieMembers
        {
            internal AllieMembers() { }
        ...
        private static AllieFullTextMembers fullTextMembers = null;
        public static AllieFullTextMembers FullTextMembers
        {
            get
            {
                if (fullTextMembers is null)
                {
                    ...
                    {
                        if (fullTextMembers is null)
                            fullTextMembers = new AllieFullTextMembers();
                    }
                }
        ...
        public class AllieFullTextMembers
        {
            internal AllieFullTextMembers() { }
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = DeckBuilder.Model.Datastore.Model.Entities["Allie"];
                }
            }
            return entity;
        }

        private static AllieEvents events = null;
        public static AllieEvents Events
        {
            get
            {
                if (events is null)
                {
                    ...
                    {
                        if (events is null)
                            events = new AllieEvents();
                    }
                }
                return events;
            }
        }
        public class AllieEvents
        {
            ...
            private EventHandler<Allie, EntityEventArgs> onNew;
            public event EventHandler<Allie, EntityEventArgs> OnNew
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Allie, EntityEventArgs> handler = onNew;
                if (handler is not null)
                    handler.Invoke((Allie)sender, args);
            }
            ...
            private EventHandler<Allie, EntityEventArgs> onDelete;
            public event EventHandler<Allie, EntityEventArgs> OnDelete
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Allie, EntityEventArgs> handler = onDelete;
                if (handler is not null)
                    handler.Invoke((Allie)sender, args);
            }
            ...
            private EventHandler<Allie, EntityEventArgs> onSave;
            public event EventHandler<Allie, EntityEventArgs> OnSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Allie, EntityEventArgs> handler = onSave;
                if (handler is not null)
                    handler.Invoke((Allie)sender, args);
            }
            ...
            private EventHandler<Allie, EntityEventArgs> onAfterSave;
            public event EventHandler<Allie, EntityEventArgs> OnAfterSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Allie, EntityEventArgs> handler = onAfterSave;
                if (handler is not null)
                    handler.Invoke((Allie)sender, args);
            }
            ...
            public static class OnPropertyChange
            {
                ...
                private static EventHandler<Allie, PropertyEventArgs> onTokens;
                public static event EventHandler<Allie, PropertyEventArgs> OnTokens
                {
                    add
                    {
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onTokens;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onName;
                public static event EventHandler<Allie, PropertyEventArgs> OnName
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onName;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onBaseEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnBaseEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onBaseEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onReactionEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnReactionEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onReactionEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onEnteringEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnEnteringEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onEnteringEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onLeavingEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnLeavingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onLeavingEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onActivationEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onMandatoryActivationEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnMandatoryActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onMandatoryActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onPermanentEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnPermanentEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onPermanentEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onLoosingEffect;
                public static event EventHandler<Allie, PropertyEventArgs> OnLoosingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onLoosingEffect;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onLore;
                public static event EventHandler<Allie, PropertyEventArgs> OnLore
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onLore;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onId;
                public static event EventHandler<Allie, PropertyEventArgs> OnId
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onId;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
                ...
                private static EventHandler<Allie, PropertyEventArgs> onCardSet;
                public static event EventHandler<Allie, PropertyEventArgs> OnCardSet
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Allie, PropertyEventArgs> handler = onCardSet;
                    if (handler is not null)
                        handler.Invoke((Allie)sender, args);
                }
        ...
        #region IAllieOriginalData

        public IAllieOriginalData OriginalVersion { get { return this; } }
