...
{
    public interface IReactionOriginalData : ICardOriginalData
    {
    }

    public partial class Reaction : OGM<Reaction, Reaction.ReactionData, System.String>, ICard, IReactionOriginalData
    {
        #region Initialize
        ...
        public static Dictionary<System.String, Reaction> LoadByKeys(IEnumerable<System.String> ids)
        {
        ...
        protected static void RegisterQuery(string name, Func<IMatchQuery, q.ReactionAlias, IWhereQuery> query)
        {
            q.ReactionAlias alias;

            IMatchQuery matchQuery = Blueprint41.Transaction.CompiledQuery.Match(q.Node.Reaction.Alias(out alias, "node"));
        ...
        protected override void LazySet()
        {
            ...
            if (PersistenceState == PersistenceState.NewAndChanged || PersistenceState == PersistenceState.LoadedAndChanged)
            {
                if (ReferenceEquals(InnerData, OriginalData))
                    OriginalData = new ReactionData(InnerData);
            }
        }
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Name is null)
                throw new PersistenceException(string.Format("Cannot save Reaction with key '{0}' because the Name cannot be null.", this.Id?.ToString() ?? "<null>"));
        }
        ...
        public class ReactionData : Data<System.String>
        {
            public ReactionData()
            {
            ...
            public ReactionData(ReactionData data)
            {
                Name = data.Name;
            ...
            #region Members for interface IReaction
        ...
        private static ReactionMembers members = null;
        public static ReactionMembers Members
        {
            get
            {
                if (members is null)
                {
                    lock (typeof(Reaction))
                    {
                        if (members is null)
                            members = new ReactionMembers();
                    }
                }
                return members;
            }
        }
        public class ReactionMembers
        {
            internal ReactionMembers() { }
        ...
        private static ReactionFullTextMembers fullTextMembers = null;
        public static ReactionFullTextMembers FullTextMembers
        {
            get
            {
                if (fullTextMembers is null)
                {
                    ...
                    {
                        if (fullTextMembers is null)
                            fullTextMembers = new ReactionFullTextMembers();
                    }
                }
        ...
        public class ReactionFullTextMembers
        {
            internal ReactionFullTextMembers() { }
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = DeckBuilder.Model.Datastore.Model.Entities["Reaction"];
                }
            }
            return entity;
        }

        private static ReactionEvents events = null;
        public static ReactionEvents Events
        {
            get
            {
                if (events is null)
        ...
        public class ReactionEvents
        {
            ...
            private EventHandler<Reaction, EntityEventArgs> onNew;
            public event EventHandler<Reaction, EntityEventArgs> OnNew
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Reaction, EntityEventArgs> handler = onNew;
                if (handler is not null)
                    handler.Invoke((Reaction)sender, args);
            }
            ...
            private EventHandler<Reaction, EntityEventArgs> onDelete;
            public event EventHandler<Reaction, EntityEventArgs> OnDelete
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Reaction, EntityEventArgs> handler = onDelete;
                if (handler is not null)
                    handler.Invoke((Reaction)sender, args);
            }
            ...
            private EventHandler<Reaction, EntityEventArgs> onSave;
            public event EventHandler<Reaction, EntityEventArgs> OnSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Reaction, EntityEventArgs> handler = onSave;
                if (handler is not null)
                    handler.Invoke((Reaction)sender, args);
            }
            ...
            private EventHandler<Reaction, EntityEventArgs> onAfterSave;
            public event EventHandler<Reaction, EntityEventArgs> OnAfterSave
            {
                add
                {
                    lock (this)
            ...
            {
                EventHandler<Reaction, EntityEventArgs> handler = onAfterSave;
                if (handler is not null)
                    handler.Invoke((Reaction)sender, args);
            }
            ...
            public static class OnPropertyChange
            {
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onName;
                public static event EventHandler<Reaction, PropertyEventArgs> OnName
                {
                    add
                    {
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onName;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onBaseEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnBaseEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onBaseEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onReactionEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnReactionEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onReactionEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onEnteringEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnEnteringEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onEnteringEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onLeavingEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnLeavingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onLeavingEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onActivationEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onMandatoryActivationEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnMandatoryActivationEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onMandatoryActivationEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onPermanentEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnPermanentEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onPermanentEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onLoosingEffect;
                public static event EventHandler<Reaction, PropertyEventArgs> OnLoosingEffect
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onLoosingEffect;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onLore;
                public static event EventHandler<Reaction, PropertyEventArgs> OnLore
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onLore;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onId;
                public static event EventHandler<Reaction, PropertyEventArgs> OnId
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onId;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
                ...
                private static EventHandler<Reaction, PropertyEventArgs> onCardSet;
                public static event EventHandler<Reaction, PropertyEventArgs> OnCardSet
                {
                    add
                    {
                        lock (typeof(OnPropertyChange))
                ...
                {
                    EventHandler<Reaction, PropertyEventArgs> handler = onCardSet;
                    if (handler is not null)
                        handler.Invoke((Reaction)sender, args);
                }
        ...
        #region IReactionOriginalData

        public IReactionOriginalData OriginalVersion { get { return this; } }
