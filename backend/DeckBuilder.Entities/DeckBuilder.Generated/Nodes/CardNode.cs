...
namespace DeckBuilder.Generated.Query
{
    ...
    {
        public static CardNode Card { get { return new CardNode(); } }
    }

    public partial class CardNode : Blueprint41.Query.Node
    {
        public static implicit operator QueryCondition(CardNode a)
        {
            return new QueryCondition(a);
        }
        public static QueryCondition operator !(CardNode a)
        {
        ...
        {
            return m.Card.Entity;
        }

        internal CardNode() { }
        internal CardNode(CardAlias alias, bool isReference = false)
        {
            NodeAlias = alias;
            IsReference = isReference;
        }
        internal CardNode(RELATIONSHIP relationship, DirectionEnum direction, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity) { }
        internal CardNode(RELATIONSHIP relationship, DirectionEnum direction, AliasResult nodeAlias, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity)
        {
            NodeAlias = nodeAlias;
        }

        public CardNode Where(JsNotation<string> ActivationEffect = default, JsNotation<string> BaseEffect = default, JsNotation<string> EnteringEffect = default, JsNotation<string> Id = default, JsNotation<string> LeavingEffect = default, JsNotation<string> LoosingEffect = default, JsNotation<string> Lore = default, JsNotation<string> MandatoryActivationEffect = default, JsNotation<string> Name = default, JsNotation<string> PermanentEffect = default, JsNotation<string> ReactionEffect = default)
        {
            if (InlineConditions is not null || InlineAssignments is not null)
                throw new NotSupportedException("You cannot, at the same time, have inline-assignments and inline-conditions defined on a node.");

            Lazy<CardAlias> alias = new Lazy<CardAlias>(delegate()
            {
        ...
        public CardNode Alias(out CardAlias alias)
        {
            if (NodeAlias is CardAlias a)
            {
                alias = a;
            }
            else
            {
                alias = new CardAlias(this);
                NodeAlias = alias;
            }
            return this;
        }
        public CardNode Alias(out CardAlias alias, string name)
        {
            if (NodeAlias is CardAlias a)
            {
                a.SetAlias(name);
            ...
            {
                alias = new CardAlias(this, name);
                NodeAlias = alias;
            }
            return this;
        }

        public CardNode UseExistingAlias(AliasResult alias)
        {
            NodeAlias = alias;
            IsReference = true;
            return this;
        ...
        public BossNode CastToBoss()
        {
            ...
            return new BossNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
        }

        public ActionNode CastToAction()
        {
            if (this.Neo4jLabel is null)
                throw new InvalidOperationException("Casting is not supported for virtual entities.");
            ...
            return new ActionNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
        }
        ...
        public ValiseNode CastToValise()
        {
            if (this.Neo4jLabel is null)
                throw new InvalidOperationException("Casting is not supported for virtual entities.");
            ...
            return new ValiseNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
        }

        public ReactionNode CastToReaction()
        {
            if (this.Neo4jLabel is null)
                throw new InvalidOperationException("Casting is not supported for virtual entities.");
            ...
            return new ReactionNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
        }


        public CardOut Out { get { return new CardOut(this); } }
        public class CardOut
        {
            private CardNode Parent;
            internal CardOut(CardNode parent)
            {
                Parent = parent;
            }
    ...
    public class CardAlias : AliasResult<CardAlias, CardListAlias>
    {
        internal CardAlias(CardNode parent)
        {
            Node = parent;
        }
        internal CardAlias(CardNode parent, string name)
        {
            Node = parent;
            AliasName = name;
        }
        ...
        private  CardAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private  CardAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private  CardAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type)
        {
            Node = alias.Node;
        }
        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Name"]) },
                        { "BaseEffect", new StringResult(this, "BaseEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["BaseEffect"]) },
                        { "ReactionEffect", new StringResult(this, "ReactionEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ReactionEffect"]) },
                        { "EnteringEffect", new StringResult(this, "EnteringEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["EnteringEffect"]) },
                        { "LeavingEffect", new StringResult(this, "LeavingEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LeavingEffect"]) },
                        { "ActivationEffect", new StringResult(this, "ActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ActivationEffect"]) },
                        { "MandatoryActivationEffect", new StringResult(this, "MandatoryActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["MandatoryActivationEffect"]) },
                        { "PermanentEffect", new StringResult(this, "PermanentEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["PermanentEffect"]) },
                        { "LoosingEffect", new StringResult(this, "LoosingEffect", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LoosingEffect"]) },
                        { "Lore", new StringResult(this, "Lore", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Lore"]) },
                        { "Id", new StringResult(this, "Id", DeckBuilder.Model.Datastore.Model.Entities["Card"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Id"]) },
                    };
                }
        ...
        public CardNode.CardOut Out { get { return new CardNode.CardOut(new CardNode(this, true)); } }
        ...
        public AsResult As(string aliasName, out CardAlias alias)
        {
            alias = new CardAlias((CardNode)Node)
            {
                AliasName = aliasName
            };
    ...
    public class CardListAlias : ListResult<CardListAlias, CardAlias>, IAliasListResult
    {
        private CardListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private CardListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private CardListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
    public class CardJaggedListAlias : ListResult<CardJaggedListAlias, CardListAlias>, IAliasJaggedListResult
    {
        private CardJaggedListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private CardJaggedListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private CardJaggedListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
}
