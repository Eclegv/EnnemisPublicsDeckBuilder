...
namespace DeckBuilder.Generated.Query
{
    ...
    {
        public static SbireNode Sbire { get { return new SbireNode(); } }
    }

    public partial class SbireNode : Blueprint41.Query.Node
    {
        public static implicit operator QueryCondition(SbireNode a)
        {
            return new QueryCondition(a);
        }
        public static QueryCondition operator !(SbireNode a)
        {
        ...
        {
            return m.Sbire.Entity;
        }
        public FunctionalId FunctionalId
        {
            get
            {
                return m.Sbire.Entity.FunctionalId;
            }
        }

        internal SbireNode() { }
        internal SbireNode(SbireAlias alias, bool isReference = false)
        {
            NodeAlias = alias;
            IsReference = isReference;
        }
        internal SbireNode(RELATIONSHIP relationship, DirectionEnum direction, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity) { }
        internal SbireNode(RELATIONSHIP relationship, DirectionEnum direction, AliasResult nodeAlias, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity)
        {
            NodeAlias = nodeAlias;
        }

        public SbireNode Where(JsNotation<string> ActivationEffect = default, JsNotation<string> BaseEffect = default, JsNotation<string> EnteringEffect = default, JsNotation<string> Id = default, JsNotation<string> LeavingEffect = default, JsNotation<string> LoosingEffect = default, JsNotation<string> Lore = default, JsNotation<string> MandatoryActivationEffect = default, JsNotation<string> Name = default, JsNotation<string> PermanentEffect = default, JsNotation<string> ReactionEffect = default)
        {
            if (InlineConditions is not null || InlineAssignments is not null)
                throw new NotSupportedException("You cannot, at the same time, have inline-assignments and inline-conditions defined on a node.");

            Lazy<SbireAlias> alias = new Lazy<SbireAlias>(delegate()
            {
        ...
        public SbireNode Alias(out SbireAlias alias)
        {
            if (NodeAlias is SbireAlias a)
            {
                alias = a;
            }
            else
            {
                alias = new SbireAlias(this);
                NodeAlias = alias;
            }
            return this;
        }
        public SbireNode Alias(out SbireAlias alias, string name)
        {
            if (NodeAlias is SbireAlias a)
            {
                a.SetAlias(name);
            ...
            {
                alias = new SbireAlias(this, name);
                NodeAlias = alias;
            }
            return this;
        }

        public SbireNode UseExistingAlias(AliasResult alias)
        {
            NodeAlias = alias;
            IsReference = true;
            return this;
        ...
        public SbireIn  In  { get { return new SbireIn(this); } }
        public class SbireIn
        {
            private SbireNode Parent;
            internal SbireIn(SbireNode parent)
            {
                Parent = parent;
            }
        ...
        public SbireOut Out { get { return new SbireOut(this); } }
        public class SbireOut
        {
            private SbireNode Parent;
            internal SbireOut(SbireNode parent)
            {
                Parent = parent;
            }
    ...
    public class SbireAlias : AliasResult<SbireAlias, SbireListAlias>
    {
        internal SbireAlias(SbireNode parent)
        {
            Node = parent;
        }
        internal SbireAlias(SbireNode parent, string name)
        {
            Node = parent;
            AliasName = name;
        }
        ...
        private  SbireAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private  SbireAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private  SbireAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type)
        {
            Node = alias.Node;
        }
        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Name"]) },
                        { "BaseEffect", new StringResult(this, "BaseEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["BaseEffect"]) },
                        { "ReactionEffect", new StringResult(this, "ReactionEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ReactionEffect"]) },
                        { "EnteringEffect", new StringResult(this, "EnteringEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["EnteringEffect"]) },
                        { "LeavingEffect", new StringResult(this, "LeavingEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LeavingEffect"]) },
                        { "ActivationEffect", new StringResult(this, "ActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ActivationEffect"]) },
                        { "MandatoryActivationEffect", new StringResult(this, "MandatoryActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["MandatoryActivationEffect"]) },
                        { "PermanentEffect", new StringResult(this, "PermanentEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["PermanentEffect"]) },
                        { "LoosingEffect", new StringResult(this, "LoosingEffect", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LoosingEffect"]) },
                        { "Lore", new StringResult(this, "Lore", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Lore"]) },
                        { "Id", new StringResult(this, "Id", DeckBuilder.Model.Datastore.Model.Entities["Sbire"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Id"]) },
                    };
                }
        ...
        public SbireNode.SbireIn In { get { return new SbireNode.SbireIn(new SbireNode(this, true)); } }
        public SbireNode.SbireOut Out { get { return new SbireNode.SbireOut(new SbireNode(this, true)); } }
        ...
        public AsResult As(string aliasName, out SbireAlias alias)
        {
            alias = new SbireAlias((SbireNode)Node)
            {
                AliasName = aliasName
            };
    ...
    public class SbireListAlias : ListResult<SbireListAlias, SbireAlias>, IAliasListResult
    {
        private SbireListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private SbireListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private SbireListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
    public class SbireJaggedListAlias : ListResult<SbireJaggedListAlias, SbireListAlias>, IAliasJaggedListResult
    {
        private SbireJaggedListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private SbireJaggedListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private SbireJaggedListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
}
