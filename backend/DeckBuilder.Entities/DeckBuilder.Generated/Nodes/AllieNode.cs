...
namespace DeckBuilder.Generated.Query
{
    ...
    {
        public static AllieNode Allie { get { return new AllieNode(); } }
    }

    public partial class AllieNode : Blueprint41.Query.Node
    {
        public static implicit operator QueryCondition(AllieNode a)
        {
            return new QueryCondition(a);
        }
        public static QueryCondition operator !(AllieNode a)
        {
        ...
        {
            return m.Allie.Entity;
        }
        public FunctionalId FunctionalId
        {
            get
            {
                return m.Allie.Entity.FunctionalId;
            }
        }

        internal AllieNode() { }
        internal AllieNode(AllieAlias alias, bool isReference = false)
        {
            NodeAlias = alias;
            IsReference = isReference;
        }
        internal AllieNode(RELATIONSHIP relationship, DirectionEnum direction, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity) { }
        internal AllieNode(RELATIONSHIP relationship, DirectionEnum direction, AliasResult nodeAlias, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity)
        {
            NodeAlias = nodeAlias;
        }

        public AllieNode Where(JsNotation<string> ActivationEffect = default, JsNotation<string> BaseEffect = default, JsNotation<string> EnteringEffect = default, JsNotation<string> Id = default, JsNotation<string> LeavingEffect = default, JsNotation<string> LoosingEffect = default, JsNotation<string> Lore = default, JsNotation<string> MandatoryActivationEffect = default, JsNotation<string> Name = default, JsNotation<string> PermanentEffect = default, JsNotation<string> ReactionEffect = default)
        {
            if (InlineConditions is not null || InlineAssignments is not null)
                throw new NotSupportedException("You cannot, at the same time, have inline-assignments and inline-conditions defined on a node.");

            Lazy<AllieAlias> alias = new Lazy<AllieAlias>(delegate()
            {
        ...
        public AllieNode Alias(out AllieAlias alias)
        {
            if (NodeAlias is AllieAlias a)
            {
                alias = a;
            }
            else
            {
                alias = new AllieAlias(this);
                NodeAlias = alias;
            }
            return this;
        }
        public AllieNode Alias(out AllieAlias alias, string name)
        {
            if (NodeAlias is AllieAlias a)
            {
                a.SetAlias(name);
            ...
            {
                alias = new AllieAlias(this, name);
                NodeAlias = alias;
            }
            return this;
        }

        public AllieNode UseExistingAlias(AliasResult alias)
        {
            NodeAlias = alias;
            IsReference = true;
            return this;
        ...
        public AllieIn  In  { get { return new AllieIn(this); } }
        public class AllieIn
        {
            private AllieNode Parent;
            internal AllieIn(AllieNode parent)
            {
                Parent = parent;
            }
        ...
        public AllieOut Out { get { return new AllieOut(this); } }
        public class AllieOut
        {
            private AllieNode Parent;
            internal AllieOut(AllieNode parent)
            {
                Parent = parent;
            }
            public IFromOut_ECLIPSING_REL ECLIPSING { get { return new ECLIPSING_REL(Parent, DirectionEnum.Out); } }
            public IFromOut_HAS_CARD_REL HAS_CARD { get { return new HAS_CARD_REL(Parent, DirectionEnum.Out); } }
        }
    }

    public class AllieAlias : AliasResult<AllieAlias, AllieListAlias>
    {
        internal AllieAlias(AllieNode parent)
        {
            Node = parent;
        }
        internal AllieAlias(AllieNode parent, string name)
        {
            Node = parent;
            AliasName = name;
        }
        ...
        private  AllieAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private  AllieAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private  AllieAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type)
        {
            Node = alias.Node;
        }
        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Name"]) },
                        { "BaseEffect", new StringResult(this, "BaseEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["BaseEffect"]) },
                        { "ReactionEffect", new StringResult(this, "ReactionEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ReactionEffect"]) },
                        { "EnteringEffect", new StringResult(this, "EnteringEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["EnteringEffect"]) },
                        { "LeavingEffect", new StringResult(this, "LeavingEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LeavingEffect"]) },
                        { "ActivationEffect", new StringResult(this, "ActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ActivationEffect"]) },
                        { "MandatoryActivationEffect", new StringResult(this, "MandatoryActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["MandatoryActivationEffect"]) },
                        { "PermanentEffect", new StringResult(this, "PermanentEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["PermanentEffect"]) },
                        { "LoosingEffect", new StringResult(this, "LoosingEffect", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LoosingEffect"]) },
                        { "Lore", new StringResult(this, "Lore", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Lore"]) },
                        { "Id", new StringResult(this, "Id", DeckBuilder.Model.Datastore.Model.Entities["Allie"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Id"]) },
                    };
                }
        ...
        public AllieNode.AllieIn In { get { return new AllieNode.AllieIn(new AllieNode(this, true)); } }
        public AllieNode.AllieOut Out { get { return new AllieNode.AllieOut(new AllieNode(this, true)); } }
        ...
        public AsResult As(string aliasName, out AllieAlias alias)
        {
            alias = new AllieAlias((AllieNode)Node)
            {
                AliasName = aliasName
            };
    ...
    public class AllieListAlias : ListResult<AllieListAlias, AllieAlias>, IAliasListResult
    {
        private AllieListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private AllieListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private AllieListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
    public class AllieJaggedListAlias : ListResult<AllieJaggedListAlias, AllieListAlias>, IAliasJaggedListResult
    {
        private AllieJaggedListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private AllieJaggedListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private AllieJaggedListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
}
