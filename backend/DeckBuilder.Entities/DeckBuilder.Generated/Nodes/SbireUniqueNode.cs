...
namespace DeckBuilder.Generated.Query
{
    ...
    {
        public static SbireUniqueNode SbireUnique { get { return new SbireUniqueNode(); } }
    }

    public partial class SbireUniqueNode : Blueprint41.Query.Node
    {
        public static implicit operator QueryCondition(SbireUniqueNode a)
        {
            return new QueryCondition(a);
        }
        public static QueryCondition operator !(SbireUniqueNode a)
        {
        ...
        {
            return m.SbireUnique.Entity;
        }
        public FunctionalId FunctionalId
        {
            get
            {
                return m.SbireUnique.Entity.FunctionalId;
            }
        }

        internal SbireUniqueNode() { }
        internal SbireUniqueNode(SbireUniqueAlias alias, bool isReference = false)
        {
            NodeAlias = alias;
            IsReference = isReference;
        }
        internal SbireUniqueNode(RELATIONSHIP relationship, DirectionEnum direction, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity) { }
        internal SbireUniqueNode(RELATIONSHIP relationship, DirectionEnum direction, AliasResult nodeAlias, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity)
        {
            NodeAlias = nodeAlias;
        }

        public SbireUniqueNode Where(JsNotation<string> ActivationEffect = default, JsNotation<string> BaseEffect = default, JsNotation<string> EnteringEffect = default, JsNotation<string> Id = default, JsNotation<string> LeavingEffect = default, JsNotation<string> LoosingEffect = default, JsNotation<string> Lore = default, JsNotation<string> MandatoryActivationEffect = default, JsNotation<string> Name = default, JsNotation<string> PermanentEffect = default, JsNotation<string> ReactionEffect = default)
        {
            if (InlineConditions is not null || InlineAssignments is not null)
                throw new NotSupportedException("You cannot, at the same time, have inline-assignments and inline-conditions defined on a node.");

            Lazy<SbireUniqueAlias> alias = new Lazy<SbireUniqueAlias>(delegate()
            {
        ...
        public SbireUniqueNode Alias(out SbireUniqueAlias alias)
        {
            if (NodeAlias is SbireUniqueAlias a)
            {
                alias = a;
            }
            else
            {
                alias = new SbireUniqueAlias(this);
                NodeAlias = alias;
            }
            return this;
        }
        public SbireUniqueNode Alias(out SbireUniqueAlias alias, string name)
        {
            if (NodeAlias is SbireUniqueAlias a)
            {
                a.SetAlias(name);
            ...
            {
                alias = new SbireUniqueAlias(this, name);
                NodeAlias = alias;
            }
            return this;
        }

        public SbireUniqueNode UseExistingAlias(AliasResult alias)
        {
            NodeAlias = alias;
            IsReference = true;
            return this;
        ...
        {
            private SbireUniqueNode Parent;
            internal SbireUniqueOut(SbireUniqueNode parent)
            {
                Parent = parent;
            }
    ...
    public class SbireUniqueAlias : AliasResult<SbireUniqueAlias, SbireUniqueListAlias>
    {
        internal SbireUniqueAlias(SbireUniqueNode parent)
        {
            Node = parent;
        }
        internal SbireUniqueAlias(SbireUniqueNode parent, string name)
        {
            Node = parent;
            AliasName = name;
        }
        ...
        private  SbireUniqueAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private  SbireUniqueAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private  SbireUniqueAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type)
        {
            Node = alias.Node;
        }
        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Name"]) },
                        { "BaseEffect", new StringResult(this, "BaseEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["BaseEffect"]) },
                        { "ReactionEffect", new StringResult(this, "ReactionEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ReactionEffect"]) },
                        { "EnteringEffect", new StringResult(this, "EnteringEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["EnteringEffect"]) },
                        { "LeavingEffect", new StringResult(this, "LeavingEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LeavingEffect"]) },
                        { "ActivationEffect", new StringResult(this, "ActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ActivationEffect"]) },
                        { "MandatoryActivationEffect", new StringResult(this, "MandatoryActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["MandatoryActivationEffect"]) },
                        { "PermanentEffect", new StringResult(this, "PermanentEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["PermanentEffect"]) },
                        { "LoosingEffect", new StringResult(this, "LoosingEffect", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LoosingEffect"]) },
                        { "Lore", new StringResult(this, "Lore", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Lore"]) },
                        { "Id", new StringResult(this, "Id", DeckBuilder.Model.Datastore.Model.Entities["SbireUnique"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Id"]) },
                    };
                }
        ...
        public AsResult As(string aliasName, out SbireUniqueAlias alias)
        {
            alias = new SbireUniqueAlias((SbireUniqueNode)Node)
            {
                AliasName = aliasName
            };
    ...
    public class SbireUniqueListAlias : ListResult<SbireUniqueListAlias, SbireUniqueAlias>, IAliasListResult
    {
        private SbireUniqueListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private SbireUniqueListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private SbireUniqueListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
    public class SbireUniqueJaggedListAlias : ListResult<SbireUniqueJaggedListAlias, SbireUniqueListAlias>, IAliasJaggedListResult
    {
        private SbireUniqueJaggedListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private SbireUniqueJaggedListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private SbireUniqueJaggedListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
}
