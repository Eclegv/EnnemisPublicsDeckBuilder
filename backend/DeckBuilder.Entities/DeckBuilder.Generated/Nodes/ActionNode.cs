...
namespace DeckBuilder.Generated.Query
{
    ...
    {
        public static ActionNode Action { get { return new ActionNode(); } }
    }

    public partial class ActionNode : Blueprint41.Query.Node
    {
        public static implicit operator QueryCondition(ActionNode a)
        {
            return new QueryCondition(a);
        }
        public static QueryCondition operator !(ActionNode a)
        {
        ...
        {
            return m.Action.Entity;
        }
        public FunctionalId FunctionalId
        {
            get
            {
                return m.Action.Entity.FunctionalId;
            }
        }

        internal ActionNode() { }
        internal ActionNode(ActionAlias alias, bool isReference = false)
        {
            NodeAlias = alias;
            IsReference = isReference;
        }
        internal ActionNode(RELATIONSHIP relationship, DirectionEnum direction, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity) { }
        internal ActionNode(RELATIONSHIP relationship, DirectionEnum direction, AliasResult nodeAlias, string neo4jLabel = null, Entity entity = null) : base(relationship, direction, neo4jLabel, entity)
        {
            NodeAlias = nodeAlias;
        }

        public ActionNode Where(JsNotation<string> ActivationEffect = default, JsNotation<string> BaseEffect = default, JsNotation<string> EnteringEffect = default, JsNotation<string> Id = default, JsNotation<string> LeavingEffect = default, JsNotation<string> LoosingEffect = default, JsNotation<string> Lore = default, JsNotation<string> MandatoryActivationEffect = default, JsNotation<string> Name = default, JsNotation<string> PermanentEffect = default, JsNotation<string> ReactionEffect = default)
        {
            if (InlineConditions is not null || InlineAssignments is not null)
                throw new NotSupportedException("You cannot, at the same time, have inline-assignments and inline-conditions defined on a node.");

            Lazy<ActionAlias> alias = new Lazy<ActionAlias>(delegate()
            {
        ...
        public ActionNode Alias(out ActionAlias alias)
        {
            if (NodeAlias is ActionAlias a)
            {
                alias = a;
            }
            else
            {
                alias = new ActionAlias(this);
                NodeAlias = alias;
            }
            return this;
        }
        public ActionNode Alias(out ActionAlias alias, string name)
        {
            if (NodeAlias is ActionAlias a)
            {
                a.SetAlias(name);
            ...
            {
                alias = new ActionAlias(this, name);
                NodeAlias = alias;
            }
            return this;
        }

        public ActionNode UseExistingAlias(AliasResult alias)
        {
            NodeAlias = alias;
            IsReference = true;
            return this;
        ...
        public ActionOut Out { get { return new ActionOut(this); } }
        public class ActionOut
        {
            private ActionNode Parent;
            internal ActionOut(ActionNode parent)
            {
                Parent = parent;
            }
    ...
    public class ActionAlias : AliasResult<ActionAlias, ActionListAlias>
    {
        internal ActionAlias(ActionNode parent)
        {
            Node = parent;
        }
        internal ActionAlias(ActionNode parent, string name)
        {
            Node = parent;
            AliasName = name;
        }
        ...
        private  ActionAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private  ActionAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private  ActionAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type)
        {
            Node = alias.Node;
        }
        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Name"]) },
                        { "BaseEffect", new StringResult(this, "BaseEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["BaseEffect"]) },
                        { "ReactionEffect", new StringResult(this, "ReactionEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ReactionEffect"]) },
                        { "EnteringEffect", new StringResult(this, "EnteringEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["EnteringEffect"]) },
                        { "LeavingEffect", new StringResult(this, "LeavingEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LeavingEffect"]) },
                        { "ActivationEffect", new StringResult(this, "ActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["ActivationEffect"]) },
                        { "MandatoryActivationEffect", new StringResult(this, "MandatoryActivationEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["MandatoryActivationEffect"]) },
                        { "PermanentEffect", new StringResult(this, "PermanentEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["PermanentEffect"]) },
                        { "LoosingEffect", new StringResult(this, "LoosingEffect", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["LoosingEffect"]) },
                        { "Lore", new StringResult(this, "Lore", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Lore"]) },
                        { "Id", new StringResult(this, "Id", DeckBuilder.Model.Datastore.Model.Entities["Action"], DeckBuilder.Model.Datastore.Model.Entities["Card"].Properties["Id"]) },
                    };
                }
        ...
        public ActionNode.ActionOut Out { get { return new ActionNode.ActionOut(new ActionNode(this, true)); } }
        ...
        public AsResult As(string aliasName, out ActionAlias alias)
        {
            alias = new ActionAlias((ActionNode)Node)
            {
                AliasName = aliasName
            };
    ...
    public class ActionListAlias : ListResult<ActionListAlias, ActionAlias>, IAliasListResult
    {
        private ActionListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private ActionListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private ActionListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
    public class ActionJaggedListAlias : ListResult<ActionJaggedListAlias, ActionListAlias>, IAliasJaggedListResult
    {
        private ActionJaggedListAlias(Func<QueryTranslator, string> function, object[] arguments, Type type) : base(function, arguments, type) { }
        private ActionJaggedListAlias(FieldResult parent, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(parent, function, arguments, type) { }
        private ActionJaggedListAlias(AliasResult alias, Func<QueryTranslator, string> function, object[] arguments = null, Type type = null) : base(alias, function, arguments, type) { }
    }
}
